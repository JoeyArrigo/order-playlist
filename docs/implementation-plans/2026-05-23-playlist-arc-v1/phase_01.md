...
**Scope:** Phase 1 of 7 from `/Users/y/Apps/music/playlistize/docs/design-plans/2026-05-23-playlist-arc-v1.md`.
...
**Project guidance:** `/Users/y/Apps/music/playlistize/implementation-plan-guidance.md`. Key rules: no `unwrap()` outside tests/`main`; missing doc comments on `pub` items block merge; cargo fmt + clippy + test + build must all pass at end of every phase.
...
**Files:**
- Create: `/Users/y/Apps/music/playlistize/Cargo.toml`
...
Run: `cd /Users/y/Apps/music/playlistize && cargo --version`
...
Run: `cd /Users/y/Apps/music/playlistize && cargo metadata --offline 2>&1 | head -5`
...
**Files:**
- Modify: `/Users/y/Apps/music/playlistize/.gitignore` (existing — 4 lines)
- Create: `/Users/y/Apps/music/playlistize/.env.example`
...
Run: `cd /Users/y/Apps/music/playlistize && cat .gitignore | grep -E 'target|cache\.json|\.env|DS_Store|snap\.new'`
Expected: All five patterns present.

Run: `cd /Users/y/Apps/music/playlistize && test -f .env.example && echo OK`
Expected: `OK`.
...
**Files:**
- Create: `/Users/y/Apps/music/playlistize/src/main.rs`
- Create: `/Users/y/Apps/music/playlistize/src/lib.rs`
- Create: `/Users/y/Apps/music/playlistize/src/errors.rs`
...
Run: `cd /Users/y/Apps/music/playlistize && cargo check 2>&1 | tail -20`
...
**Files:**
- Create: `/Users/y/Apps/music/playlistize/src/domain/mod.rs`
- Create: `/Users/y/Apps/music/playlistize/src/algo/mod.rs`
- Create: `/Users/y/Apps/music/playlistize/src/adapters/mod.rs`
- Create: `/Users/y/Apps/music/playlistize/src/cli/mod.rs`
...
Run: `cd /Users/y/Apps/music/playlistize && cargo build 2>&1 | tail -10`
Expected: `Compiling playlistize v0.1.0 ...` followed by `Finished ...`. Zero errors, zero warnings.

Run: `cd /Users/y/Apps/music/playlistize && cargo test 2>&1 | tail -10`
...
Run the verification commands listed in `/Users/y/Apps/music/playlistize/implementation-plan-guidance.md` ("What 'done' looks like per phase"):
...
Run: `cd /Users/y/Apps/music/playlistize && git log --oneline -1`
