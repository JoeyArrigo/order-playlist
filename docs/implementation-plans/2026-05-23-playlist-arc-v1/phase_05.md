...
**Scope:** Phase 5 of 7 from `/Users/y/Apps/music/playlistize/docs/design-plans/2026-05-23-playlist-arc-v1.md`.
...
- Create: `/Users/y/Apps/music/playlistize/src/adapters/musicbrainz.rs` (stub — full impl in Tasks 4–5)
...
Run: `cd /Users/y/Apps/music/playlistize && cargo build --features musicbrainz`
...
Run: `cd /Users/y/Apps/music/playlistize && cargo build && cargo test --lib errors`
Expected: green.
...
**Files:**
- Create: `/Users/y/Apps/music/playlistize/tests/support/mod.rs`
- Create: `/Users/y/Apps/music/playlistize/tests/support/in_memory.rs`
...
Run: `cd /Users/y/Apps/music/playlistize && cargo test --test in_memory_resolver_smoke`
...
**Files:**
- Create: `/Users/y/Apps/music/playlistize/src/adapters/musicbrainz.rs`
...
Run: `cd /Users/y/Apps/music/playlistize && cargo test --features musicbrainz --lib adapters::musicbrainz::tests`
Expected: all pass.
...
**Files:**
- Modify: `/Users/y/Apps/music/playlistize/src/adapters/musicbrainz.rs`
...
Run: `cd /Users/y/Apps/music/playlistize && cargo test --features musicbrainz --lib adapters::musicbrainz`
...
**Files:**
- Modify: `/Users/y/Apps/music/playlistize/src/adapters/musicbrainz.rs`
- Modify: `/Users/y/Apps/music/playlistize/Cargo.toml` (add `wiremock = "=0.6.4"` to `[dev-dependencies]`)
...
**Files:**
- Create: `/Users/y/Apps/music/playlistize/tests/musicbrainz_live.rs`
...
async fn resolves_get_lucky_to_isrc() {
    ...
    let resolver = MusicBrainzIsrcResolver::new(
        cache,
        "playlistize-test/0.1 (test@example.com)".into(),
    ).unwrap();
...
Without the feature:
```bash
cd /Users/y/Apps/music/playlistize && cargo test --test musicbrainz_live 2>&1 | head -5
```
Expected: builds with zero tests in this file (the cfg excludes everything).

With the feature (network required):
```bash
cd /Users/y/Apps/music/playlistize && cargo test --features musicbrainz,live-network --test musicbrainz_live 2>&1 | tail -10
```
...
Add the re-export so Phase 7's `main.rs` can `use playlistize::adapters::MusicBrainzIsrcResolver`:
